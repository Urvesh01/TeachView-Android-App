...
public class HomePage extends AppCompatActivity {
    ...
    TextView day;
    String[] item = {"Dweepna Garg (DG)","Bhavika Patel (BNP)","Binal Kaka (BSK)","Chirag Patel (CIP)","Dhruvi Gosai (DDG)","Janardan Bharvad(JB)","Khushi Patel (KAP)","Kashyap Patel (KSP)","Kajal Parmar (KPP)","Minal Patel (MP)","Nisha Panchal (NAP)","Prassan Barot (PDB)","Sanjay Patel (SRP)","sachi Joshi (SVJ)","Shraddha Vyas (SPV)","Urvashi Chaudhari (UMC)"};
